...
const Contact = () => {
    ...
    const formSubmit = (e) => {
        ...
        alert(`My name is ${data.fullName}. My mobile no. is ${data.phone}. My email is ${data.email}. My msg is ${data.sms}.`);
    };
    return (
        <>
            <Header></Header>
                        ...
                        <form onSubmit={formSubmit}>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="sms" value={data.sms} onChange={InputEvent}></textarea>
                                </div>
                                <div class="col-12">
